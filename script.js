// Imágenes predefinidas (Data URLs pequeñas para ejemplos)
        const defaultImages = [
            { id: 1, name: "Pizza Margarita", url: "./img/margarita.jpg"},
            { id: 2, name: "Pizza Pepperoni", url: "./img/pizza-peperoni.webp" },
            { id: 3, name: "Pizza 4 Quesos", url: "./img/4-quesos.jpg" },
            { id: 4, name: "Pizza Vegetariana", url: "./img/vegetariana.jpg" },
            { id: 5, name: "Pizza Hawaiana", url: "./img/pizza-hawaiana.webp" }
        ];
